...
namespace AC
{
	...
	public class InvItem : ITranslatable
	{
		...
		private static GUIContent deleteContent = new GUIContent ("-", "Delete item");
		...
		private void InteractionCallback (object obj)
		{
			if (sideInteraction >= 0)
			{
				...
				{
					case "Insert after":
						Undo.RecordObject (KickStarter.inventoryManager, "Insert item");
						InvInteraction newInteraction = new InvInteraction (KickStarter.cursorManager.cursorIcons[0]);
